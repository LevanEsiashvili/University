...
namespace University.Infrastructure.Migrations
{
    ...
    [Migration("20230806210210_changestundentsubjectexam")]
    partial class changestundentsubjectexam
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("University.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6af7e55f-8910-4552-acf0-16a31a847a0e"),
                            BirtsDate = new DateTime(2023, 8, 7, 1, 2, 10, 378, DateTimeKind.Local).AddTicks(1136),
                            CreatedDate = new DateTime(2023, 8, 7, 1, 2, 10, 378, DateTimeKind.Local).AddTicks(1124),
                            Email = "1",
                            FirstName = "admin",
                            IsDeleted = false,
                            LastName = "admin",
                            PasswordHash = new byte[] { 9, 0, 226, 245, 106, 42, 253, 70, 164, 16, 162, 20, 32, 178, 237, 22, 58, 43, 172, 242, 206, 17, 37, 166, 133, 177, 228, 210, 46, 196, 186, 196, 5, 56, 110, 236, 49, 230, 107, 59, 203, 75, 204, 159, 90, 84, 118, 47, 230, 115, 38, 247, 70, 96, 129, 85, 200, 77, 97, 92, 48, 192, 46, 49 },
                            PasswordSalt = new byte[] { 95, 149, 200, 60, 88, 247, 159, 12, 31, 8, 197, 98, 211, 71, 119, 181, 102, 236, 155, 64, 88, 225, 246, 129, 34, 29, 144, 194, 17, 156, 165, 84, 159, 144, 209, 59, 198, 69, 155, 134, 153, 212, 216, 206, 159, 29, 42, 93, 25, 192, 187, 146, 131, 36, 34, 10, 52, 38, 167, 184, 110, 16, 16, 40, 250, 215, 135, 183, 241, 40, 211, 215, 56, 114, 17, 40, 7, 172, 149, 21, 174, 229, 177, 83, 136, 183, 152, 97, 160, 149, 143, 79, 160, 192, 178, 169, 139, 198, 60, 56, 135, 71, 197, 153, 196, 188, 71, 134, 141, 118, 21, 49, 113, 243, 28, 197, 249, 55, 56, 63, 109, 130, 186, 132, 20, 241, 4, 49 },
                            PhoneNumber = "admin",
                            PrivateNumber = "admin",
                            Role = 0
                        });
